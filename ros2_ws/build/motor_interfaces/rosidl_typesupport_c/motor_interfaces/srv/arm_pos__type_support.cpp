...
static const _ArmPos_Request_type_support_symbol_names_t _ArmPos_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, motor_interfaces, srv, ArmPos_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, motor_interfaces, srv, ArmPos_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, motor_interfaces, srv, ArmPos_Request)() {
  return &::motor_interfaces::srv::rosidl_typesupport_c::ArmPos_Request_message_type_support_handle;
}
...
static const _ArmPos_Response_type_support_symbol_names_t _ArmPos_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, motor_interfaces, srv, ArmPos_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, motor_interfaces, srv, ArmPos_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, motor_interfaces, srv, ArmPos_Response)() {
  return &::motor_interfaces::srv::rosidl_typesupport_c::ArmPos_Response_message_type_support_handle;
}
...
static const _ArmPos_type_support_symbol_names_t _ArmPos_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, motor_interfaces, srv, ArmPos)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, motor_interfaces, srv, ArmPos)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, motor_interfaces, srv, ArmPos)() {
  return &::motor_interfaces::srv::rosidl_typesupport_c::ArmPos_service_type_support_handle;
}
